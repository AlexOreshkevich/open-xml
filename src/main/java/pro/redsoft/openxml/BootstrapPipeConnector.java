...
public class BootstrapPipeConnector extends BootstrapConnector {
   ...
   * @return The component context
   */
  public XComponentContext connect(String pipeName) throws BootstrapException, Exception {
    ...
    return connect(oooAcceptOption, unoConnectString, 0);
  }
   ...
   * @return The component context
   */
  public static final XComponentContext bootstrap(String oooExecFolder) throws BootstrapException, Exception {
   ...
   * @return The component context
   */
  public static final XComponentContext bootstrap(String oooExecFolder, String pipeName) throws BootstrapException, Exception {
